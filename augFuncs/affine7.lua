function jitter(s)
  ...
  S[1][2] = torch.rand(1):div(2)
  S[2][1] = torch.rand(1):div(2)
  ...
  T2[1][3] = torch.rand(1):mul(10):add(64):add(-5)
  T2[2][3] = torch.rand(1):mul(10):add(64):add(-5)
  T2[3][3] = 1

  local Sc = torch.eye(3,3):mul(torch.randn(1):div(10):add(1)[1])
  local Asp = torch.eye(3,3)
  local a = torch.rand(1):div(2):add(0.75)
  Asp[1][1] = a[1]
  Asp[2][2] = 1/a[1]
