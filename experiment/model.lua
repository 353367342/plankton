...
features:add(nn.SpatialConvolution(fSize[1],fSize[2],10,10,2,2)) -- (128 - 10 + 2)/2 = 60
features:add(nn.Threshold(0,1e-6))
features:add(nn.SpatialMaxPooling(2,2)) -- 30
features:add(nn.SpatialConvolution(fSize[2],fSize[3],7,7)) -- 24
features:add(nn.Threshold(0,1e-6))
features:add(nn.SpatialMaxPooling(2,2)) -- 12
features:add(nn.SpatialConvolution(fSize[3],fSize[4],5,5)) -- 8 
features:add(nn.Threshold(0,1e-6))
