...
features:add(nn.SpatialConvolutionMM(fSize[1],fSize[2],9,9)) -- 128 - 9 + 1 = 120
features:add(nn.Threshold(0,1e-6))
features:add(nn.SpatialMaxPooling(2,2)) --  60
features:add(nn.SpatialConvolutionMM(fSize[2],fSize[3],7,7)) -- 54
features:add(nn.Threshold(0,1e-6))
features:add(nn.SpatialMaxPooling(2,2)) -- 27
features:add(nn.SpatialConvolutionMM(fSize[3],fSize[4],6,6)) -- 22
features:add(nn.Threshold(0,1e-6))
