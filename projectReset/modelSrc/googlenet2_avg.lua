...
features[1]:add(nn.SpatialConvolutionMM(1,128,2,2,2,2)) -- 60
features[1]:add(nn.ReLU())
features[1]:add(nn.SpatialMaxPooling(2,2)) -- 30
features[1]:add(nn.SpatialConvolutionMM(128,192,3,3))    --28
features[1]:add(nn.ReLU())
features[1]:add(nn.SpatialConvolutionMM(192,210,4,4)) -- 25
features[1]:add(nn.ReLU())
features[1]:add(nn.SpatialConvolutionMM(210,226,2,2)) -- 24
features[1]:add(nn.ReLU())
features[1]:add(nn.SpatialMaxPooling(2,2))
features[1]:cuda()

features[2] = nn.Sequential()
features[2]:add(inception_module(2,226,{{64}, {96, 128}, {16, 32}, {3, 32}}))
