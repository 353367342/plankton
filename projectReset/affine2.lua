function jitter(s)
 local d = torch.rand(2)
  ...
  S[1][2] = torch.rand(1):div(12)
  S[2][1] = torch.rand(1):div(12)
  ...
  T2[1][3] = torch.randn(1):mul(3):add(-1.5):add(64)
  T2[2][3] = torch.randn(1):mul(3):add(-1.5):add(64)
  T2[3][3] = 1

  local   Sc = torch.eye(3,3):mul(torch.randn(1):div(25):add(0.98)[1])
